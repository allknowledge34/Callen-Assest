...
class SearchInfoActivty : BaseActivity<ActivityContectDetialActivtyBinding>() {
    ...
    companion object {
        ...
        private const val TAG = "Search_Info_Act"
    }
...
//                InterstitialAds.Show_google_Interstitialads(this@SearchInfoActivty, "ContDetail_Act_BACK")
                finish()
            }
        ...
        Log.e("Contect_Event--", "SearchDetail_Act_onCreate")
        MyApplication.mFirebaseAnalytics?.logEvent("SearchDetail_Act_onCreate", Bundle())
    }
    ...
    private fun initiateWhatsAppCall(context: Context, phoneNumber: String, isVideoCall: Boolean) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.UPSIDE_DOWN_CAKE) {
            ...
            if (isAppInstalled("com.whatsapp")) {
                ...
                val name = getContactName(recent_model!!.number, this@SearchInfoActivty)
                val whatsappcall = getContactIdForWhatsAppCall(name, this@SearchInfoActivty)
                if (whatsappcall != 0) {
    ...
    private fun initiateWhatsAppVideoCall(
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.UPSIDE_DOWN_CAKE) {
            ...
            if (isAppInstalled("com.whatsapp")) {
                ...
                val videocall = getContactIdForWhatsAppVideoCall(name, this@SearchInfoActivty)
                if (videocall != 0) {
                    intent.setDataAndType(
    ...
    private fun showAdView() {
        if (Ads_Utils.showGoogleNativeSearchDetail == "yes") {
            if (Ads_Utils.onlyMoreNativeBanner == "yes") {
                ...
                Native_Banner_Goggle_Ad(
                    activity = this,
                    adID = Ads_Utils.GNB_SEARCH_DETAILS,
    ...
    fun showPopup(v: View, callLog: ContactModel) {
        ...
        rel_delete.setOnClickListener(View.OnClickListener {
            ...
            val delete_dialog = Dialog(this@SearchInfoActivty)
            ...
            btn_delete.setOnClickListener {
                ...
                try {
                    deleteContact(this@SearchInfoActivty, recent_model!!.name, recent_model!!.number)
    ...
    fun deleteContact(context: Context, name: String ,number: String) {
        try {
            ...
            if (rowsUpdated > 0) {
                serach_number = true
                Glob.showToast(this@SearchInfoActivty, getString(R.string.toast_delete));
    ...
    private fun showCustomInstallDialog() {
        wp_dialogue = Dialog(this@SearchInfoActivty)
